...
class ComputePowerElecWeight(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:propulsion:power_electronics:pe_specific_power", val=np.nan, units="W/kg")

        self.add_output("data:weight:propulsion:power_electronics:mass", units="kg")

    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):

        max_power = inputs["data:propulsion:HE_engine:max_power"]
        pe_spec_power = inputs["data:propulsion:power_electronics:pe_specific_power"]
