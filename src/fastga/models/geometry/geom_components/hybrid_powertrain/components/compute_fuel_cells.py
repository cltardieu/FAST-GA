...
class ComputeFuelCells(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:propulsion:hybrid_powertrain:fuel_cell:fc_type", val='',
                       desc="Optional specified model of fuel cell")

        self.add_output("data:propulsion:hybrid_powertrain:fuel_cell:design_power", units='J')
        ...
        self.add_output("data:geometry:hybrid_powertrain:fuel_cell:stack_volume", units='m**3')
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs['data:geometry:hybrid_powertrain:fuel_cell:design_power'] = design_power
        outputs['data:geometry:hybrid_powertrain:fuel_cell:current_density'] = current_density
        ...
        outputs['data:geometry:hybrid_powertrain:fuel_cell:cell_voltage'] = V_cell
